      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">Pay Maya</option>
            </select>
         </div>
         <div class="inputBox">
            <span>Address #1 :</span>
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="e.g. caloocan city" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Barangay :</span>
            <input type="text" name="state" placeholder="e.g. barangay 170 " class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="pin_code" placeholder="e.g. 1420" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
